...
class List:
    ...
    def clean(self):
        ...
        while i < len(self._values):
            if self._values[i] in seen:
                del self._values[i]
            else:
                seen.add(self._values[i])
                i += 1
    ...
    def intersection(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        self._values = [value for value in source1._values if value in source2._values]
        self.clean()
    ...
    def max(self):
        ...
        return deepcopy(max(self._values))
    ...
    def min(self):
        ...
        return deepcopy(min(self._values))
    ...
    def split(self):
        ...
        target1 = List()
        target2 = List()
        target1._values = self._values[:half]
        target2._values = self._values[half:]
        self._values = []
